...
from .views import (
    ...
    StartGrammarPracticeView,
    SubmitGrammarAnswerView,
    CompleteGrammarPracticeView,
...
urlpatterns = [
    ...
    # Grammar practice
    path('topics/<uuid:topic_id>/grammar/start', StartGrammarPracticeView.as_view(), name='start_grammar'),
    path('topics/<uuid:topic_id>/grammar/answer', SubmitGrammarAnswerView.as_view(), name='submit_grammar_answer'),
    path('topics/<uuid:topic_id>/grammar/complete', CompleteGrammarPracticeView.as_view(), name='complete_grammar'),
